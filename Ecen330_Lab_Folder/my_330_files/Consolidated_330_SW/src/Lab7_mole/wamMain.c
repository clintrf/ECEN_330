...
#include "../Lab3_timers_ecen330/intervalTimer.h"  // Modify as necessary to point to your intervalTimer.h
#include "supportFiles/leds.h"
#include "supportFiles/interrupts.h"
#include "../Lab2_switch_button/switches.h"  // Modify as necessary to point to your switches.h
#include "../Lab2_switch_button/buttons.h"   // Modify as necessary to point to your buttons.h
#include <stdio.h>
...
#define TIMER_PERIOD 60.0E-3//50.0E-3    // 50 ms.
...
#define MAX_MISSES 10       // Game is over when there are this many misses.
...
int main() {
    ...
    /******************** Game-Specific Code ********************/
    uint32_t randomSeed = 0;    // Used to make the game seem more random.
